...
if $::operatingsystem == 'RedHat'
{
  ...
  notify {"NOT CHECKED Ensure Red Hat Network or Subscription Manager connection is configured":}
...
{ 
#1.2.1
  notify {"NOT CHECKED 1.2.1 Ensure package manager repositories are configured ":}
  
#1.2.2
  notify {"NOT CHECKED 1.2.2 Ensure GPG keys are configured":}
